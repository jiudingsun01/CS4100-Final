...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_names', help='Name of the datasets to be loaded', type=list, required=False, default=HELD_IN_DATASETS)
    parser.add_argument('--edit_layer', help='Layer for intervention.', type=int, required=False, default=12)
    ...
    parser.add_argument('--epochs', help='Batch size of inference and training intervention', type=int, required=False, default=50)
